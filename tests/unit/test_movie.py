...
@pytest.fixture
def movie():
    return Movie(0, "Harry Potter", 2010, "Wizards", "1", [], [], "1")

def test_movie(movie):
    assert repr(movie) == "<Movie Harry Potter, 2010>"

def test_init():
    movie1 = Movie(0, "Harry Potter", 2010, "Wizards", "1", [], [], "1")
...
def test_movie_different():
    movie1 = Movie(0, "Harry Potter", 2010, "Wizards", "1", [], [], "1")
    movie2 = Movie(1, "Ronald Weasley", 2010, "Wizards", "1", [], [], "1")
    assert movie1 != movie2

def test_movie_more():
    movie2 = Movie(1, "Ronald Weasley", 2010, "Wizards", "1", [], [], "1")
    movie3 = Movie(1, "Ronald Weasley", 2011, "Wizards", "1", [], [], "1")
